        ...
        function () {
            ...
            Route::prefix('product')->group(
                function () {
                    ...
                    Route::get('trash', [AdminProductController::class, 'showTrash'])->name('trashProduct');
                    Route::get('restore/{id?}', [AdminProductController::class, 'restore'])->name('restoreProduct');
                    Route::get('forceDelete/{id?}', [AdminProductController::class, 'forceDelete'])->name('forceDeleteProduct');
                }
            );
